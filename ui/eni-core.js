...
export const ENI_MULTIPART = {
    ...
    NODE_TECH_AQ_WRITING: {
        ...
        split: true,
        parts: [
            { key: 'ENI_AQ_STEP_WRITING_CIVS', label: '2 civilizations met' },
            { key: 'ENI_AQ_STEP_WRITING_BORDERS', label: 'Open Borders requested' },
        ],
    },
    ...
    NODE_CIVIC_AQ_MAIN_LITERACY: {
        ...
        unit: 'Codices',
        parts: [
            { key: 'ENI_AQ_STEP_LITERACY_1', at: 1, label: '1 Codex' },
    ...
    NODE_CIVIC_AQ_MAIN_COMMERCE: {
        ...
        unit: 'civilizations',
        parts: [
            { key: 'ENI_AQ_STEP_COMMERCE_1', at: 1, label: '1 civilization' },
    ...
    NODE_TECH_AQ_MATHEMATICS: {
        need: 2,
        unit: 'staffed Libraries',
        parts: [
            { key: 'ENI_AQ_STEP_MATHEMATICS_1', at: 1, label: '1 staffed Library' },
            { key: 'ENI_BOOST_NODE_TECH_AQ_MATHEMATICS', at: 2, label: '2 staffed Libraries' },
        ],
    },
    NODE_TECH_EX_EDUCATION: {
        need: 3,
        unit: 'staffed Observatories',
        parts: [
            { key: 'ENI_EX_STEP_EDUCATION_1', at: 1, label: '1 staffed Observatory' },
            { key: 'ENI_EX_STEP_EDUCATION_2', at: 2, label: '2 staffed Observatories' },
            { key: 'ENI_BOOST_NODE_TECH_EX_EDUCATION', at: 3, label: '3 staffed Observatories' },
        ],
    },
    NODE_TECH_EX_ARCHITECTURE: {
        ...
        unit: 'Kilns',
        parts: [
            { key: 'ENI_EX_STEP_ARCHITECTURE_1', at: 1, label: '1 Kiln' },
            { key: 'ENI_EX_STEP_ARCHITECTURE_2', at: 2, label: '2 Kilns' },
            { key: 'ENI_BOOST_NODE_TECH_EX_ARCHITECTURE', at: 3, label: '3 Kilns' },
        ],
    },
    NODE_TECH_EX_METAL_CASTING: {
        ...
        unit: 'Armorers',
        parts: [
            { key: 'ENI_EX_STEP_METAL_CASTING_1', at: 1, label: '1 Armorer' },
            { key: 'ENI_BOOST_NODE_TECH_EX_METAL_CASTING', at: 2, label: '2 Armorers' },
        ],
    },
    NODE_TECH_EX_URBAN_PLANNING: {
        ...
        unit: 'Cities',
        parts: [
            { key: 'ENI_EX_STEP_URBAN_PLANNING_1', at: 1, label: '1 City' },
    ...
    NODE_CIVIC_EX_BRANCH_REFORMATION: {
        ...
        unit: 'Temples',
        parts: [
            { key: 'ENI_EX_STEP_REFORMATION_1', at: 1, label: '1 Temple' },
            { key: 'ENI_EX_STEP_REFORMATION_2', at: 2, label: '2 Temples' },
            { key: 'ENI_BOOST_NODE_CIVIC_EX_BRANCH_REFORMATION', at: 3, label: '3 Temples' },
        ],
    },
    NODE_CIVIC_EX_MAIN_INSPIRATION: {
        ...
        unit: 'Relics',
        parts: [
            { key: 'ENI_EX_STEP_INSPIRATION_1', at: 1, label: '1 Relic' },
    ...
    NODE_CIVIC_EX_MAIN_SOCIAL_CLASS: {
        ...
        unit: 'Taverns',
        parts: [
            { key: 'ENI_EX_STEP_SOCIAL_CLASS_1', at: 1, label: '1 Tavern' },
            { key: 'ENI_EX_STEP_SOCIAL_CLASS_2', at: 2, label: '2 Taverns' },
            { key: 'ENI_EX_STEP_SOCIAL_CLASS_3', at: 3, label: '3 Taverns' },
            { key: 'ENI_BOOST_NODE_CIVIC_EX_MAIN_SOCIAL_CLASS', at: 4, label: '4 Taverns' },
        ],
    },
    ...
    NODE_TECH_MO_ELECTRICITY: {
        ...
        unit: 'Resources',
        parts: [
            { key: 'ENI_MO_STEP_ELECTRICITY_1', at: 1, label: '1 Resource' },
    ...
    NODE_TECH_MO_URBANIZATION: {
        ...
        unit: 'City Parks',
        parts: [
            { key: 'ENI_MO_STEP_URBANIZATION_1', at: 1, label: '1 City Park' },
            { key: 'ENI_MO_STEP_URBANIZATION_2', at: 2, label: '2 City Parks' },
            { key: 'ENI_BOOST_NODE_TECH_MO_URBANIZATION', at: 3, label: '3 City Parks' },
        ],
    },
    NODE_TECH_MO_MASS_PRODUCTION: {
        ...
        unit: 'settlements',
        parts: [
            { key: 'ENI_MO_STEP_MASS_PRODUCTION_1', at: 1, label: '1 settlement' },
    ...
    NODE_CIVIC_MO_MAIN_HEGEMONY: {
        ...
        unit: 'Museums',
        parts: [
            { key: 'ENI_MO_STEP_HEGEMONY_1', at: 1, label: '1 Museum' },
    ...
    try {
        ...
        st.textContent =
            ...
            /* The node was ALREADY researched when the marker fired, so the boost paid nothing.
               ...
               .eni-pop-x rules come last so they win the cascade tie against .eni-pop-c. */
            '.eni-pop.eni-pop-x{background:linear-gradient(180deg,#141a1e,#0d1114);border-color:#5d6b76;}' +
            '.eni-pop.eni-pop-x .eni-pop-title{color:#9fb0bd;}' +
            '.eni-pop.eni-pop-x .eni-pop-node{color:#c9bda0;}' +
            '.eni-pop.eni-pop-x .eni-pop-deed{color:#8e9aa3;}';
